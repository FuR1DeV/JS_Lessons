...
function startGame() {
    ...
    barrier = setInterval(createBarrier, barrier_timer);
}
...
function move() {
    ...
    if (!isSnakeUnit(new_unit) && new_unit !== isBarrier && new_unit !== undefined) {
...
function createBarrier() {
    ...
    while (!barrierCreated) {
        ...
        if (!barrier_cell_classes.includes('snake-unit') && ('food-unit')) {
            var classes = '';
...
function finishTheGame() {
    ...
    alert('Game over! Your result: ' + score.toString());
}
